...
$d.Add('rewriting its record. To resolve one, find the line in the *Legacy lines* column')
$d.Add('below - `test/cap11a/ci-legacy-inventory.tsv` carries the same numbers - and read')
$d.Add('across to the new location. The legacy file itself remains readable at any commit')
$d.Add('up to and including the twin-run commit.')
$d.Add('')
