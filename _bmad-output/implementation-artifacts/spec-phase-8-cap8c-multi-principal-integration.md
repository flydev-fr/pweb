...
- [x] CAP-8 final artifact + canonical status update — ONLY after hosted aggregation is green: concise record referencing CAP-8A/CAP-8B closures, the three principal contexts, grant behavior, precedence, platform/lifecycle matrices, CI runs, freeze result, waivers. (Done: `cap8-final-artifact.md`, hosted closure run 32827378066.)
