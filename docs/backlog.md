...
carries **338 entries** from Phase 0 to CAP-11B. It is a ledger: it records
what was found, in the words of the shard that found it, and it never edits
itself. That makes it excellent evidence and a poor worklist — a reader who
wants to know *what is still owed* has to resolve every supersession chain by
hand, and three phase-closure artifacts answer that question for CAP-10 and
CAP-11 only.

This document is the worklist. Every one of the 338 entries is disposed of
exactly once, with one verdict, an owner and a reason. **Forty-five are open,**
**and those forty-five are listed here in full**; the other 293 are in
