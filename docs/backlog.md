...
carries **426 entries** from Phase 0 to CAP-15C. It is a
...
This document is the worklist. Every one of the 426 entries is disposed of
exactly once, with one verdict, an owner and a reason. **Sixty are open,**
**and those sixty are listed here in full**; the other 366 are in
...
| `ROADMAP` | 53 | real work, deferred, with a named owner |
